...
#[derive(Debug)]
pub struct BlockLogErrOut<'a, A: LogExtend<'a>>(A, PhantomData<&'a ()>);

impl<'a, A: LogExtend<'a>> BlockLogErrOut<'a, A> {
     #[inline(always)]
     pub fn new(a: A) -> Self {
          BlockLogErrOut(
               a, PhantomData,
...
impl<'a, A: LogExtend<'a> + Clone> Clone for BlockLogErrOut<'a, A> {
     #[inline(always)]
     fn clone(&self) -> Self {
          BlockLogErrOut::new(self.0.clone())
     }
}


impl<'a, A: LogExtend<'a>> LogFlush<'a> for BlockLogErrOut<'a, A> {
     #[inline(always)]
...
impl<'a, A: LogExtend<'a>> LogBase<'a> for BlockLogErrOut<'a, A> {
     #[inline(always)]
...
impl<'a, A: LogExtend<'a>> LogLockIO<'a> for BlockLogErrOut<'a, A> {
     #[inline(always)]
...
impl<'a, A: LogExtend<'a>> LogExtend<'a> for BlockLogErrOut<'a, A> {}
impl<'a, A: LogExtend<'a>> LogStatic<'a> for BlockLogErrOut<'a, A> {}
